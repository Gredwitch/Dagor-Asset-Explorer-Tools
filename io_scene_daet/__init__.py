...
class ImportDPL(bpy.types.Operator, ImportHelper):
	...
	max_occurences_cnt: IntProperty(
		name="Max model occurences",
		description="Models that have a higher number of occurences will not be imported",
	...
	optimize_models: BoolProperty(
		...
		description = "Merge vertices by distance and decimates models by 0.4",
		default = True,
	)
...
class DPL_PT_import_misc(bpy.types.Panel):
	...
	def draw(self, context):
		...
		layout.prop(operator, "optimize_models")
